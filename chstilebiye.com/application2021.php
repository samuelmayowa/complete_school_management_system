            ...
            <table width="80%" align="center">
                    <form method="post" action="login.php">
                        ...
                        <td colspan="2">
                            ...
                            <tr><td><label>Application Type: </label></td><td>
                                <select size="1" width="30px" type="text" name="appType">
                                    <option value="<?php if(isset($appType)){ echo ($appType); }?>" ><?php if(isset($appType)){ echo ($appType); }?></option> </select></td></tr>
                            <tr><td><label>ApplicationFees: </label></td><td><input type="text" name="applFees" value="<?php if(isset($applfees)){ echo ($applfees); }?>"
 contenteditable="false" disabled> </input></td></tr>
